...
Then, import the fonts.css file into your _app.js or _app.tsx file.
   ...
   ```
Replace '../styles/fonts.css' with the actual path to your CSS or SCSS file. E.G globals.css

4. **Extend Tailwind's Configuration**
To use the font in your Tailwind CSS classes, extend your Tailwind CSS configuration. In your tailwind.config.js file, extend the fontFamily theme:

module.exports = {
  theme: {
    extend: {
      fontFamily: {
        'plex-mono': ['IBM Plex Mono Medium', 'sans-serif'],
      },
    },
  },
  variants: {},
...
-----> Now, you can use the font in your Tailwind CSS classes:

<h1 className="font-plex-mono">Hello, world!</h1>


----> Alternatively, you can use the class directly in JSX:

   ```jsx
   <div style={{ fontFamily: 'IBM Plex Mono Medium', fontWeight: 500 }}>
